...
class retinanet(nn.Module):
    def __init__(self, num_classes, phi, pretrained=False):
        ...
        #-----------------------------------------#
        #   Take out three effective feature layers, namely C3, C4, C5
        #   C3     75,75,512
        #   C4     38,38,1024
        #   C5     19,19,2048
        #-----------------------------------------#
        ...
        #-----------------------------------------#
        #   After FPN, 5 effective feature layers can be obtained. They are：
        #   P3     75,75,256
        #   P4     38,38,256
        #   P5     19,19,256
        #   P6     10,10,256
        ...
        #----------------------------------------------------------#
        #   Pass the obtained P3, P4, P5, P6, P7 to
        # Make predictions in Retinahead, get regression prediction results and classification prediction results
        # Stack the prediction results of all feature layers
        #----------------------------------------------------------#
